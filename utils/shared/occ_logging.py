...
"""
Logging infrastructure for NeurCADRecon operations.
"""
...
logger = logging.getLogger("NeurCADRecon")
...
def setup_logging(level: int = logging.INFO, log_file: str = None):
    ...
    if not logger.handlers:
        ...
        console.setFormatter(logging.Formatter("[%(asctime)s] [NeurCADRecon] %(message)s", datefmt="%H:%M:%S"))
